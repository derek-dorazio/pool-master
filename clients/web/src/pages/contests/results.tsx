...
export function Component() {
  ...
  async function handleShare() {
    ...
    const shareTitle = `PoolMaster results: ${winner.entryName}`;
    const shareText = `${winner.entryName} leads the contest results with ${winner.totalScore} points.`;
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Based on the latest persisted standings
          </p>
        </div>
      ...
      <Card className="border-yellow-200 bg-gradient-to-br from-yellow-50 to-amber-50">
        <CardContent className="flex flex-col items-center gap-4 p-8 text-center">
          ...
          <div>
            <p className="text-sm font-medium text-yellow-700">Leader</p>
