...
| 54-003 | 1 | Remove scoring-template and selection-template config surfaces that assume a template subsystem | In Progress | Scoring-template routes, DTOs, registry, and contest wiring removed; selection-template cleanup remains for a later pass |
