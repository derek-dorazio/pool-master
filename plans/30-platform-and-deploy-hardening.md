...
|---|---|---|---|---|
| PDH-001 | CI/CD | Remove or sharply reduce `continue-on-error` from deploy-critical steps in [ci.yml](/Users/DDorazio/Library/CloudStorage/OneDrive-CURRICULUMASSOCIATESLLC/Documents/Claude/pool-master/.github/workflows/ci.yml) | Done | Deploy-critical backend and frontend steps now fail the workflow directly instead of degrading into best-effort drift, and lint/typecheck no longer swallows ESLint failures. |
