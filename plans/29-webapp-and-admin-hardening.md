...
| WAH-008 | Browser Tests | Rebuild browser E2E around the narrowed MVP journeys and expand only after those flows stabilize | In Progress | Legacy shallow Playwright smoke suites were deleted and replaced with [mvp-browser.smoke.ts](/Users/DDorazio/Library/CloudStorage/OneDrive-CURRICULUMASSOCIATESLLC/Documents/Claude/pool-master/clients/web/e2e/mvp-browser.smoke.ts), which now covers real league/invite and contest-setup browser journeys. Remaining work is live QA stabilization plus follow-up flows like logout and key settings once the current MVP paths are stable |
