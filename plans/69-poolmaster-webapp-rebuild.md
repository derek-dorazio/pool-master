...
| In Progress | Build the first product flow slice (69-D) | Auth entry flow, generated-SDK-backed member league list, league detail, and invitation-acceptance routes are now in place; contest detail/standings and invitation send/generation are the next member/commissioner seams |
