...
| In Progress | Build the first product flow slice (69-D) | Auth entry flow, generated-SDK-backed member league list, league detail, invitation acceptance, and commissioner invite send/generation are now in place; contest detail/standings are the next high-value member/commissioner seam |
