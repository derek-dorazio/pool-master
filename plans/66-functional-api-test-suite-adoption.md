...
| Pending | Execute the domain coverage slices from Plan 64 | Auth, consent, leagues/invitations, contests/entries, and standings/history are now covered; continue the remaining domain slices without reintroducing retired model assumptions |
