...
The current launch target only needs **minimal history**:
...
- deep record books
- rivalry views
- advanced luck/power analytics
- commissioner import/export tooling beyond what is needed for basic reviewability
...
> **MVP scope note:** The historical task list above records substantial implementation work, but the active product scope only requires the minimal contest-history surfaces described in the section above.
