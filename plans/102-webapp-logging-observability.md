...
| WLO-005 | 4 | Feature-level logging backfill and branch proof | In Progress | Auth/session, first-pass league/team workflows, contest workflows, and account/root-admin workflows are complete (`auth-provider`, `auth-home-page`, `session-store`, `join-league-page`, `join-team-owner-page`, `create-league-modal`, `teams-page`, `create-contest-page`, `contest-detail-page`, `contest-entry-page`, `my-account-page`, `root-admin-page`); routes and app-shell remain. |
