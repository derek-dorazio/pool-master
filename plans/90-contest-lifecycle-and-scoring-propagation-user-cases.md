# Plan 90 Note: Contest Lifecycle And Scoring Propagation
...
- legacy plan ID continuity for references from earlier design slices

## Current Product And Technical Source Of Truth
...
Scoring propagation and lifecycle behavior should be treated as backend
automation work unless the current requirements explicitly add a user-facing
workflow. Do not reopen product questions from older prose in this file.
