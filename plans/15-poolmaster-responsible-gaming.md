...
|---|---|---|---|---|
| 15-001 | 1 | Privacy policy page (published, accessible from registration) | Done | privacy.tsx implemented |
| 15-002 | 1 | Terms of service page (acceptance at registration) | Done | terms.tsx implemented |
| 15-003 | 1 | Age verification at registration (DOB collection, 13+ check) | Done | verifyAge() + POST /api/v1/account/verify-age |
| 15-004 | 1 | Cookie consent banner (EU/UK/California) | Done | cookie-banner.tsx implemented |
