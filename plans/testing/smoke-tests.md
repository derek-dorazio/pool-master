...
|---|---|---|---|---|
| — | — | All 38 smoke test tasks deferred to [plans/deferred/smoke-tests-deferred.md](../deferred/smoke-tests-deferred.md) | — | Requires deployed environment; see deferred file for details |
