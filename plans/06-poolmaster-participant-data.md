...
|---|---|---|---|---|
| 06-001 | 1 | `participants` table + migrations (core schema) | Not Started | |
| 06-002 | 1 | `participant_season_records` table + migrations | Not Started | |
| 06-003 | 1 | Participant CRUD service + API endpoints | Not Started | |
| 06-004 | 1 | Ingestion integration (consume from sports data layer) | Not Started | Depends on 05-004 |
| 06-005 | 1 | PostgreSQL full-text search on participants (`tsvector`) | Not Started | |
| 06-006 | 1 | Provider ID mapping table and resolution | Not Started | |
| 06-007 | 2 | `contest_participant_pools` table + migrations | Not Started | |
| 06-008 | 2 | `contest_pool_participants` table + migrations | Not Started | |
| 06-009 | 2 | Contest pool creation and resolution (EVENT_FIELD, RANKING_CUTOFF, CUSTOM) | Not Started | |
| 06-010 | 2 | Pool lifecycle (create → resolve → review → lock) | Not Started | |
| 06-011 | 2 | Pool refresh on field changes | Not Started | |
| 06-012 | 2 | Withdrawal/scratch handling post-lock | Not Started | |
| 06-013 | 3 | Salary cap pricing engine (ranking + form + odds → price) | Not Started | |
| 06-014 | 3 | Price calculation and refresh schedule | Not Started | |
| 06-015 | 3 | Commissioner price overrides | Not Started | |
| 06-016 | 3 | Tier auto-assignment (AUTO_RANKING, AUTO_PRICE) | Not Started | |
| 06-017 | 3 | Commissioner tier review and manual adjustments | Not Started | |
| 06-018 | 4 | Photo ingestion pipeline (download, resize, WebP, S3, CDN) | Not Started | |
| 06-019 | 4 | Fallback image system per sport/position | Not Started | |
| 06-020 | 4 | Enhanced search — Elasticsearch migration (if needed) | Not Started | |
| 06-021 | 4 | Faceted filtering (nationality, position, team, ranking) | Not Started | |
| 06-022 | 4 | Draft room search optimisation (< 100ms) | Not Started | |
| 06-023 | 5 | Cross-provider participant matching (fuzzy name + sport) | Not Started | |
| 06-024 | 5 | Manual resolution queue in admin dashboard | Not Started | |
| 06-025 | 5 | Participant merge tooling | Not Started | |
| 06-026 | 5 | Form rating calculation engine | Not Started | |
| 06-027 | 5 | Season stat aggregation pipeline | Not Started | |
