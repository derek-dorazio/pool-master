# Ultimate Pool Manager — Bracket Contest Plan (Deferred)
...
> **Deferred for MVP:** Bracket contests are not part of the current first reviewable product. Keep this document as future-planning reference only, and re-analyze it against the current contestant model, contest scope, and scoring contracts before resuming implementation.
