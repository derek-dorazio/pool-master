...
| MCFP-007 | Tiering / Pricing | Verify odds, rankings, and seed data drive tier and price derivation deterministically | In Progress | Managed contest creation now derives deterministic tier membership/order from imported odds and ranking source data; budget-style price derivation is still a follow-on enhancement |
...
| MCFP-012 | Golf Field Synthesis | Create believable deterministic upcoming-event fields, rankings, and odds from completed tournaments and stable historical/reference signals | Done | The first-pass golf catalog now carries deterministic fields, rankings, prices, completed calibration events, and upcoming U.S. Open / Scottish Open / Open Championship snapshots; future slices should deepen field size, late alternates, and event-to-event drift |
