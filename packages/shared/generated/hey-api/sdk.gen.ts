 ...
 */
export const adminRunContestQaWorkflow = <ThrowOnError extends boolean = false>(options: Options<AdminRunContestQaWorkflowData, ThrowOnError>) => (options.client ?? client).post<AdminRunContestQaWorkflowResponses, AdminRunContestQaWorkflowErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
