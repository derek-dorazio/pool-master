...
/**
 * Prepare contest-ready sport data
 *
 * Triggers manual provider sync plus event-detail hydration for the requested sport so root-admins can unblock contest-ready event data.
 */
